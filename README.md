# demucs real-time implementation

This repo is an fork and with fine-tune recipes for personal applications. Main operations are still the same as the original repo.    
