...
add_flags(parser)
parser.add_argument("--out_dir", type=str, default="outputs/enhanced",
...
#python enhance.py --streaming 1 --out_dir '' --noisy_dir '/home/vapi/ML-denoiser/dataset/jordan_test' --model_path '/home/vapi/ML-denoiser/outputs/large'
#python -m denoiser.enhance --noisy_dir '/home/vapi/ML-denoiser/dataset/jordan_test' --model_path '/home/vapi/ML-denoiser/outputs/large/best.th' --out_dir 'outputs/enhanced/large'