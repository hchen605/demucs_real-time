...
class NoisyCleanSet:
    def __init__(self, json_dir, matching="sort", length=None, stride=None,
                 pad=True, sample_rate=None, mel_args=None, dynamic_noiser_args=None):
        """__init__.
        ...
        if dynamic_noiser_args is not None:
            noisy_json = clean_json
        ...
        if dynamic_noiser_args:
            kw["dynamic_noiser_args"] = dynamic_noiser_args
